    ...
    <div class="w-full">
        ...
        <div class="font-[sans-serif] py-4 mx-auto lg:max-w-7xl sm:max-w-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                @foreach ($t_rolls as $t_r_o)


            <a href="{{ route('trolls.show', ['troll' => $t_r_o->id]) }}"
                ...
                <img src="{{ asset("storage/$t_r_o->product_image") }}" alt="{{ $t_r_o->title }}"
...
<x-pri-button :link="route('trolls')">{{ __('messages.learn-more') }}</x-pri-button>
