    ...
    <div class="w-full">
        ...
        <div class="font-[sans-serif] py-4 mx-auto lg:max-w-7xl sm:max-w-full">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                @foreach ($doorHandle as $d_handle)

            <a href="{{ route('doorHandle.show', ['doorHandle' => $d_handle->id]) }}"
                class="bg-gray-50 shadow-sm overflow-hidden rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative">
                {{-- <div
                ...
                <div class="w-5/6 h-[200px] p-4 overflow-hidden mx-auto aspect-w-8 aspect-h-4">
                <img src="{{ asset("storage/$d_handle->product_image") }}" alt="{{ $d_handle->title }}"
...
<x-pri-button :link="route('doorHandle')">{{ __('messages.learn-more') }}</x-pri-button>
