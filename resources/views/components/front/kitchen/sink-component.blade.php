<section class="flex flex-col items-center justify-center">
    ...
    <div class="w-full">
        ...
        <div class="font-[sans-serif] py-4 mx-auto lg:max-w-7xl sm:max-w-full">
            ...
            <a href="{{ route('sinks.show', ['sink' => $ss->id]) }}"
                ...
                <img src="{{ asset("storage/$ss->product_image") }}" alt="{{ $ss->title }}"
...
<x-pri-button :link="route('sinks')">{{ __('messages.learn-more') }}</x-pri-button>
