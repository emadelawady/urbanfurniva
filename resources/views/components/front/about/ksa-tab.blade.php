<div class="flex gap-2 w-full font-[sans-serif]">
    {{-- <ul class="min-w-[200px] h-min rounded-lg inline-block border">
        <li id="homeTab-1"
            class="tab-1 flex items-center text-sm text-primary bg-secondary py-5 px-5 cursor-pointer transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] rtl:ml-4 ltr:mr-4" viewBox="0 0 511 511.999">
                <path
            ...
            {{ __('outer-tabs.address') }}
        </li>
        <li id="settingTab-1"
            class="tab-1 flex items-center text-sm font-semibold text-primary py-5 px-5 cursor-pointer transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" stroke="currentColor" class="w-[18px] rtl:ml-4 ltr:mr-4"
            ...
            {{ __('outer-tabs.address-2') }}
        </li>
    </ul> --}}

    <div class="w-full">
        <div id="homeContent-1" class="tab-content-1 block w-full">
            <!-- Panel #1 -->

                {{-- <figure class="w-full">
                    <img class="w-full h-[180px] min-[480px]:h-full object-cover rounded-lg" width="304" height="214" src="./tabs-image-01.jpg" alt="Tab 01" />

                    <iframe class="w-full h-[180px] min-[480px]:h-full object-cover rounded-lg" width="304" height="214" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1503.761647674271!2d50.2126891858529!3d26.30809785100954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e49e9596fb32855%3A0x54b4b575d3236f6e!2sLandreach%20Business%20Consultant!5e0!3m2!1sar!2ssa!4v1731777813156!5m2!1sar!2ssa" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </figure> --}}
                <div class="w-full flex flex-col justify-center p-5 pl-3">
                    <div class="flex justify-between mb-1">
                        <header>
                            <div class="font-caveat text-xs font-medium text-sky-500 mb-1">{{ __('outer-tabs.need') }}</div>
                            <h1 class="font-bold text-slate-900 text-3xl mb-5">
                                {{ __('about.head-location') }}
                            </h1>
                        </header>
                    ...
                    <div class="text-slate-800 text-md line-clamp-3 mb-5">
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-4">
                        ...
                        {{-- <div class="flex items-center justify-center">
                            ...
                            <a href="#" class="mx-4 text-sky-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">
                                {{ __('outer-tabs.address-ksa') }}
                            </a>
        ...
        <div id="settingContent-1" class="tab-content-1 w-full hidden">
            <!-- Panel #1 -->
            ...
            <div class="w-full flex flex-col justify-center p-5 pl-3">
                <div class="flex justify-between mb-1">
                    <header>
                        <div class="font-caveat text-xs font-medium text-sky-500 mb-1">{{ __('outer-tabs.need') }}</div>
                        <h1 class="font-bold text-slate-900 text-3xl mb-5">{{ __('outer-tabs.contact') }}</h1>
                    </header>
                    <button class="shrink-0 h-[30px] w-[30px] border border-slate-200 hover:border-slate-300 rounded-full shadow inline-flex items-center justify-center focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 transition-colors duration-150 ease-in-out" aria-label="Like">
                        <svg class="fill-red-500" xmlns="http://www.w3.org/2000/svg" width="14" height="13">
                            <path d="M6.985 1.635C5.361.132 2.797.162 1.21 1.7A3.948 3.948 0 0 0 0 4.541a3.948 3.948 0 0 0 1.218 2.836l5.156 4.88a.893.893 0 0 0 1.223 0l5.165-4.886a3.925 3.925 0 0 0 .061-5.663C11.231.126 8.62.094 6.985 1.635Zm4.548 4.53-4.548 4.303-4.54-4.294a2.267 2.267 0 0 1 0-3.275 2.44 2.44 0 0 1 3.376 0c.16.161.293.343.398.541a.915.915 0 0 0 .766.409c.311 0 .6-.154.767-.409.517-.93 1.62-1.401 2.677-1.142 1.057.259 1.797 1.181 1.796 2.238a2.253 2.253 0 0 1-.692 1.63Z" />
                ...
                <div class="text-slate-800 text-xs line-clamp-3 mb-5">

                    {{ __('outer-tabs.specialized') }}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let contents = document.querySelectorAll('.tab-content-1');
        ...
        tabs.forEach(function (tab) {
            tab.addEventListener('click', function (e) {
                ...
                tabs.forEach(function (tab) {
                    tab.classList.remove('font-semibold', 'text-blue-600', 'bg-secondary');
                ...
                tab.classList.add('font-semibold', 'text-blue-600', 'bg-secondary');
