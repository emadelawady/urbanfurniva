<section class="my-24 dark:bg-gray-900">
    ...
    <div class="px-4 pt-20 mx-auto max-w-screen-xl sm:py-10 lg:px-6">
        ...
        <div class="grid grid-cols-1 mt-20 text-center">
            <div>
                <p class="font-bold text-xl">{{ __('homepage.let-urban') }}</p>
            </div>
        </div>
    </div>
  </section>
