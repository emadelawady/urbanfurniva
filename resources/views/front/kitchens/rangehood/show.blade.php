<x-layout>
    ...
    <x-slot:title>
        {!! config('app.name') !!} - {{ $rangeHood->title }}
    </x-slot>
...
<div class="min-w-screen min-h-screen flex flex-col items-center p-5 lg:p-10 overflow-hidden relative">
    ...
    <div class="w-full max-w-6xl flex my-12">
        <x-filament::breadcrumbs class="bg-gray-50 p-2 rounded-md" :breadcrumbs="[
            ...
            route('range.hood') => __('messages.range-hood'),
            'javascript:avoid(0)' => $rangeHood->title,
            // '' => '',
        ]" />
    </div>
    ...
    <div class="w-full max-w-6xl rounded bg-white shadow-md p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
        ...
        <div class="md:flex items-center -mx-10">
            ...
            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                <div class="relative">
                    <img src="{{ asset("storage/$rangeHood->product_image") }}" class="w-full rounded-lg relative z-10" alt="">
...
<div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        @foreach ($rangeHoodAll as $r_h)

        <!-- CARD 1 -->
        <div class="rounded overflow-hidden shadow-lg flex flex-col">
            {{-- <a href="#"></a> --}}
            <div class="relative">
                <a href="{{ route('range.hood.show', ['rangeHood' => $r_h->id]) }}">
                    <img class="w-full h-64"
                        src="{{ asset("storage/$r_h->product_image") }}"
