...
<x-slot:title>
    {!! config('app.name') !!} - {{ $furniture->title }}
</x-slot>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            <div class="pro-detail w-full flex flex-col justify-center order-last lg:order-none max-lg:max-w-[608px] max-lg:mx-auto">
                ...
                <div class="block w-full mt-12">
                    {{-- <p class="font-medium text-lg leading-8 text-gray-900 mb-4">لون المطبخ</p> --}}
                    <div class="text">


                        <div class="block w-full mb-6 mt-12">
                            <p class="font-medium text-lg leading-8 text-gray-900 mb-4">نوع</p>
                            <div class="grid grid-cols-2 min-[400px]:grid-cols-3 gap-3">
                                <button
                                    class="text-gray-900 text-lg py-2 px-1.5 sm:px-6 w-full">
                                    {{ $furniture->model }}
                                </button>
                                {{-- <button
            ...
            <div class="">
                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                    ...
                    <div class="swiper-wrapper">
                        @foreach (collect($furniture->product_image)->take(4) as $furniture_prod_image)
                            <div class="swiper-slide">
                                <img src="{{ asset("storage/$furniture_prod_image") }}"
                ...
                <div thumbsSlider="" class="swiper product-thumb max-w-[608px] mx-auto">
                    <div class="swiper-wrapper mx-auto">
                        @foreach (collect($furniture->product_image)->take(4) as $furniture_prod_2_image)
                        <div class="swiper-slide">
                            <img src="{{ asset("storage/$furniture_prod_2_image") }}" alt="Travel Bag image"
...
<x-front.furnitures.best-furniture />


{{-- <x-front.furnitures.random-furniture /> --}}
