<x-layout>
    ...
    <x-slot:title>
        {!! config('app.name') !!} - {{ $diningroom->title }}
    </x-slot>
...
<div class="min-w-screen min-h-screen flex flex-col items-center p-5 lg:p-10 overflow-hidden relative">
    ...
    <div class="w-full max-w-6xl flex my-12">
        <x-filament::breadcrumbs class="bg-gray-50 p-2 rounded-md" :breadcrumbs="[
            ...
            route('furniture.diningroom') => __('messages.diningroom'),
            'javascript:avoid(0)' => $diningroom->title,
            // '' => '',
        ]" />
    </div>
        ...
        <div class="md:flex items-center -mx-10">
            ...
            <div class="w-full md:w-1/2 px-10">
                    ...
                    <div class="w-full my-4">
                        ...
                        <div class="flex my-2">
                            ...
                            <p class="mx-4 text-gray-500">
                                {{ $diningroom->upholstery_material }}
                            </p>
                        </div>
                        <div class="flex my-2">
                            <span class="text-app-orange-2">
            ...
            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                <div class="relative">
                    ...
                    :model="collect($diningroom->product_image)->take(4)"
                    :swiperClass="'furniture-diningroom-product-prev'"
                    :swiperThumb="'furniture-diningroom-product-thumb'"
...
<div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="border-b mb-5 flex justify-between text-sm">
        ...
        <a href="{{ route('furniture.diningroom') }}" class="hover:text-indigo-600">مشاهدة الكل</a>
    </div>


    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">

        @foreach ($diningroomAll as $d_r_a)

        <!-- CARD 1 -->
        <div class="rounded overflow-hidden shadow-lg flex flex-col">
            {{-- <a href="#"></a> --}}
            <div class="relative">
                <a href="{{ route('furniture.diningroom.show', ['diningroom' => $d_r_a->id]) }}">


                    @foreach ($d_r_a->product_image as $dro)

                        @if ($loop->first)

                            <img
                            src="{{ asset("storage/$dro") }}"
                            alt="{{ $d_r_a->title }}"
                            class="w-full h-64"
                            />
                        @endif
