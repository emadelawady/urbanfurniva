<x-layout>
    ...
    <x-slot:title>
        {!! config('app.name') !!}- {{ __('messages.living-room') }}
    </x-slot>
    ...
    <section class="mt-24">
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            ...
            <div class="w-full max-w-6xl flex">
                <x-filament::breadcrumbs class="bg-gray-50 p-2 rounded-md" :breadcrumbs="[
                    ...
                    'javascript:avoid(0)' => __('messages.living-room'),
                    // '' => '',
                ]" />
            </div>
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            ...
            <x-front.furniture.FurnitureCategoriesComponent
                :attr="\App\Enums\FurnitureCategoriesEnum::LivingRoom->getData()"
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <header>
            ...
            <x-heading :link="'javascript:avoid(0)'" class="text-xl font-bold text-gray-900 sm:text-3xl">{{  __('messages.living-room') }}</x-heading>
          ...
          <ul class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            @foreach ($livingRoom as $room)


            {{-- @dd($room) --}}

            <li class="border rounded-lg mx-4 p-2">
              <a href="{{ route('furniture.livingroom.show', ['livingRoom' => $room->id]) }}" class="group block overflow-hidden p-4">

                @foreach ($room->product_image as $ro)
                    ...
                    @if ($loop->first)
                        ...
                        alt=""
                        class="h-[150px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[250px] rounded-md"
                        />
                    @endif
                ...
                <div class="relative bg-white pt-3 mt-4">
                  ...
                  <p class="mt-2">
                    ...
                    <span class="tracking-wider text-gray-900 text-xs"> {{ $room->model }} </span>
                  </p>
                </div>
              </a>
            </li>
